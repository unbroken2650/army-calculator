function calc() {
    ...
    var totalDays = parseInt((dischargeDate.getTime() - joinDate.getTime())/(1000*60*60*24), 10);
    var leftDays = parseInt((dischargeDate.getTime() - currentDate.getTime())/(1000*60*60*24), 10);
    var leftPercent = parseInt((totalDays - leftDays)/totalDays*10000, 10)/100;
